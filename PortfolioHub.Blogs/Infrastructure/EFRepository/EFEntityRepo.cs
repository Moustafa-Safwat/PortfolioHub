...
{
    protected readonly BlogsDbContext dbContext = dbContext;
    ...
    public async Task<Result<IReadOnlyList<TEntity>>> GetAllAsync(int pageNumber, int pageSize, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Result<IReadOnlyList<TEntity>>> IsEntitiesIdValidAsync(IList<Guid> ids, CancellationToken cancellationToken = default)
    {
