...
using PortfolioHub.Blogs.Usecases.Blogs.Publish;
...
) : EndpointWithoutRequest<Result>
{
    ...
    public async override Task HandleAsync(CancellationToken ct)
    {
        ...
        var publishBlogCommand = new PublishBlogCommand(blogId, userGuid);
        var result = await sender.Send(publishBlogCommand, ct);
