...
using PortfolioHub.Blogs.Usecases.Blogs.UnLike;
using System.Security.Claims;

namespace PortfolioHub.Blogs.Endpoints.Blogs;

internal sealed class UnLike
(
    ISender sender
) : EndpointWithoutRequest<Result>
{
    ...
    public async override Task HandleAsync(CancellationToken ct)
    {
        ...
        var unLikeBlogCommand = new UnLikeBlogCommand(blogId, userGuid);
        var result = await sender.Send(unLikeBlogCommand, ct);
